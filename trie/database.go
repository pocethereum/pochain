...
func (db *Database) Cap(limit common.StorageSize) error {
	...
	for size > limit && oldest != (common.Hash{}) {
		...
		// Iterate to the next flush item, or abort if the size cap was achieved. PlotSize
...
// PlotSize returns the current storage size of the memory cache in front of the

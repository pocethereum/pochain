...
import (
	...
	"github.com/pocethereum/pochain/internal/build"
)
...
func buildFlags(env build.Environment) (flags []string) {
	if os.Getenv("BINGDEV") == "true" {
		flags = append(flags, "-gcflags=\"all=-N -l\" -ldflags=\"-linkmode=internal -s\"")
	} else {
		var ld []string
		if env.Commit != "" {
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "eth.com/eth/mainchain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "eth.com/eth/mainchain/mobile")

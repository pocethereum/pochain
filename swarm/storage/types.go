...
import (
	...
	"github.com/pocethereum/pochain/bmt"
...
// in case it is a retrieval request, Data is nil and PlotSize is 0
// Note that PlotSize is not the size of the data chunk, which is Data.PlotSize()

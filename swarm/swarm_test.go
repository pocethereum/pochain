...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/poce.ipc",
			endpoint:    "/data/testnet/poce.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/poce.ipc",
			endpoint:    "/data/testnet/poce.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/poce.ipc",
			endpoint:    "/data/testnet/poce.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/poce.ipc",
			endpoint:    "/data/testnet/poce.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},

...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "poce.ipc", false, filepath.Join(os.TempDir(), "poce.ipc")},
		{"data", "poce.ipc", false, "data/poce.ipc"},
		{"data", "./poce.ipc", false, "./poce.ipc"},
		{"data", "/poce.ipc", false, "/poce.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "poce.ipc", true, `\\.\pipe\poce.ipc`},
		{"data", "poce.ipc", true, `\\.\pipe\poce.ipc`},
		{"data", `\\.\pipe\poce.ipc`, true, `\\.\pipe\poce.ipc`},
	}
